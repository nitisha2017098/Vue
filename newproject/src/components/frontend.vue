      ...
      <div class="row">
        <div class="col-md-6">
          <b-card class="profile">
            ...
            <div class="col-md-12 mt-2 qrcode" v-if="showPasswordForm" >
                ...
                <div class="authenticate">
                  ...
                  <b-button
                    ...
                    <feather-icon
                      icon="lock"
                      class="font-awesome fa-lock"
                    />
                  Authenticate
                  </b-button>
                </div>
            </div>
            <div class="col-md-12 mt-2" v-if="!showPasswordForm && !showQRCode">
                <div class="authenticate">
                  <div class="password">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <b-button
                  variant="primary"
                  dusk="updateProfile"
                  :disabled="disabled_profile_update_and_spin"
                  @click="updateProfile">
                  {{ $t("Update") }}
                   <b-spinner
                  v-if="disabled_profile_update_and_spin"
                  small
                  variant="light"
                  class="ml-1"
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <b-button
                  variant="primary"
                  dusk="updatePassword"
                  :disabled="disabled_password_update_and_spin"
                  @click="updatePassword">
                  {{ $t('Update')}}
                   <b-spinner
                    v-if="disabled_password_update_and_spin"
                    small
                    variant="light"
                    class="ml-1"
                    label="Small Spinning">
...
//   import { 
    ...
    // BInputGroup,
    // BFormTextarea,
    // BInputGroupPrepend,BBadge,BFormRadioGroup, BSpinner, BDropdownItem,BDropdown, BImg  } from "bootstrap-vue";
//   import ToastificationContent from '@core/components/toastification/ToastificationContent.vue';
//   import { togglePasswordVisibility,confirmTogglePasswordVisibility } from "@core/mixins/ui/forms";
...
//   import vSelect from "vue-select";
  export default {
    ...
    //   BInputGroup,
    //   BFormTextarea,
    //   BInputGroupPrepend,BBadge,BFormRadioGroup, BSpinner, BDropdownItem,BDropdown
    },
  ...
  .qrcode{position: relative; width: 180px; margin: 0 auto;}
  .qrcode button{position: absolute; margin: 0 auto; left: 0; right: 0; top:45%;}
